...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
        ...
        <p className='sm:w-1/3 text-center text-sm'>simply browse thorugh out extensive list of trusted docutes,schedule your appointment with your favourite doctor</p>
